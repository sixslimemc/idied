...
scoreboard players operation *imre_ready _idied = *imre _idied
execute if score *imre _idied matches 1 if score *imre_supported _idied matches 1 as @a at @s run function idied:_/main/player/set_imre_data/do